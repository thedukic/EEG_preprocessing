...
% for i = 1:NBLK
%     fprintf('Cleaning block: %1d\n', i);
%     [EEG(i).data, ~, analyticsResults] = clean_data_with_zapline_plus(EEG(i).data,EEG(i).srate,'noisefreqs',50,'winSizeCompleteSpectrum',10,'plotResults',false);
%
