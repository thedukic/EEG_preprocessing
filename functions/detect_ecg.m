function [ECGmask, ECGEpochs, ECGlatency, heartData, brainData, pulsEstimate] = detect_ecg(DATA, cfg)
...
% Select ECG
ecg_type = DATA.ALSUTRECHT.subject.ecg;
...
if do_plot
    ...
    title_str = sprintf('Detected ECG QRS (N = %d; %s)', num_epoch, ecg_type);
