...
if nargin < 1
    error('testSignificantFrequencies:NoData','Must provide data as the first argument');
elseif nargin < 2
    error('testSignificantFrequencies:NoParameters','Must provide a lineNoise parameter structure as second argument');
end
...
if isempty(tapers)
    error('testSignificantFrequencies:NoTapers','Must provide a tapers field in the lineNoise parameter structure');
end
