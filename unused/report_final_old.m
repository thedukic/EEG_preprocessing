function report_final_old(myPaths,subjects)
% =========================================================================
%
...
% Report folder
myPaths.reports = fullfile(myPaths.preproc, 'reports', myPaths.codever);
...
% CorrelationMatrices = NaN(NCHN+3,NCHN+3,NSUB);
CorrelationMatrices = NaN(NCHN,NCHN,NSUB);
...
for i = 1:NSUB
    ...
    % File names
    fileName1 = fullfile(myPaths.preproc, subjects{i}, myPaths.codever, [subjects{i} '_T' num2str(myPaths.visit) '_' myPaths.task '_cleandata_' myPaths.codever 'a.mat']);
    fileName2 = fullfile(myPaths.preproc, subjects{i}, myPaths.codever, [subjects{i} '_T' num2str(myPaths.visit) '_' myPaths.task '_cleandata_' myPaths.codever 'b.mat']);
    ...
    if exist(fileName2, "file") == 2
        ...
        % Correlation matrix
        % if size(EEG.ALSUTRECHT.chanCorr,1) == 131
        % CorrelationMatrices(:,:,i) = EEG.ALSUTRECHT.chanCorr;
        % else
        %     c = EEG.ALSUTRECHT.chanCorr(1:128,1:128);
        %
        %     N = size(c, 1); % Get the dimension N
        %
        %     % 2. Concatenate in a single line to create the (N+1) x (N+1) final matrix
        %     c = [[c; NaN(1, N)], NaN(N + 1, 1)];
        % end
        CorrelationMatrices(:,:,i) = EEG.ALSUTRECHT.chanCorr(1:128,1:128);

        % Check IC quality
        spatialSmoothnessTmp = estimate_spatialsmoothnes(EEG, 0);
...
print(fh,fullfile(myPaths.reports, ['Summary1_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r400');
...
set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
print(fh,fullfile(myPaths.reports, ['Summary2_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r400');
...
set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
print(fh,fullfile(myPaths.reports, ['Summary3_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r400');
...
set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
print(fh,fullfile(myPaths.reports, ['Summary4_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r400');
...
set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
print(fh,fullfile(myPaths.reports, ['Summary5_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r400');
...
for i = 1:NSUB
    ...
    fileName = fullfile(myPaths.preproc, subjects{i}, myPaths.codever, [subjects{i} '_T' num2str(myPaths.visit) '_' myPaths.task '_cleandata_' myPaths.codever 'b.mat']);
...
if cnt > 0
    ...
    set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
    set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
    print(fh,fullfile(myPaths.reports, ['Summary6_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r300');
    % close(fh);
end
...
set(fh,'InvertHardCopy','Off','Color',[1 1 1]);
set(fh,'PaperPositionMode','Manual','PaperUnits','Centimeters','PaperPosition',[0 0 plotX plotY],'PaperSize',[plotX plotY]);
print(fh,fullfile(myPaths.reports, ['Summary7_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime]),'-dtiff','-r300');
...
% =========================================================================
% Report table
save(fullfile(myPaths.reports, ['Summary_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task '_' myPaths.proctime]),'tableIssues');
writetable(tableIssues,fullfile(myPaths.reports, ['Summary_' myPaths.group '_T' num2str(myPaths.visit) '_' myPaths.task  '_' myPaths.proctime '.xlsx']),"WriteMode","overwrite");
